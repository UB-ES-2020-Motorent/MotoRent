...
Revision ID: 93d14626b663
Revises: 
Create Date: 2020-12-05 07:09:33.926370
...
def upgrade():
    ...
    sa.Column('id_rental', sa.Integer(), nullable=False),
    sa.Column('id_bank_data', sa.Integer(), nullable=False),
    sa.Column('payment_import', sa.Float(), nullable=False),
    sa.Column('payment_date', sa.String(), nullable=True),
    sa.PrimaryKeyConstraint('id_payment'),
    sa.UniqueConstraint('id_payment'),
    sa.UniqueConstraint('id_rental')
    )
